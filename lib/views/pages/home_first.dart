...
class _HomeState extends State<Home> with AutomaticKeepAliveClientMixin {
  ...
  Future<void> initializePageAsync({bool clearCache = false}) async {
    try {
      ...
      List<SignalInfo>? newSignal =
          await SignalModel.instance.getClosedSignalsFeed(page: loadedPage + 1);
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          MostConsistentChannel(
            medal: medal,
            futureList: getMostConsistentChannels(),
          ),
          const SizedBox(height: 20),
          Container(
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: ElevatedButton(
                          ...
                          child: const Text("Subscribe for Rp300.000",
                              style: TextStyle(
                                  fontSize: 12,
                                  fontWeight: FontWeight.w400,
                                  fontFamily: 'Manrope')),
