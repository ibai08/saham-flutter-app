...
class SignalDetailController extends GetxController {
  ...
  Future<void> initializeSignalAsync({bool clearCache = false}) async {
    ...
    try {
      ...
      // TODOs: cek ini nanti
      List<SignalTradeCopyLogSlim> tradeSignal = await SignalModel.instance.getSignalTradeByMe(signalid.value, refreshSeconds: refresh);
      listTrade.value = tradeSignal;
    } catch (xerr) {
