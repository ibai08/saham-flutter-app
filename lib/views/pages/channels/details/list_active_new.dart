...
import 'package:saham_01_app/controller/list_active_controller.dart';
import 'package:saham_01_app/views/widgets/signal_detail.dart';
...
class ListActiveSignal extends StatelessWidget {
  ...
  List<Widget> getSignals(List<SignalInfo> cc) {
    ...
    cc.forEach((signal) {
      ...
      String openTime = DateFormat("dd MMM yyyy HH:mm").format(DateTime.parse(validOpenTime).add(const Duration(hours: 7))) + " WIB";
      if (signal.expired == 0) {
