  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    var raisedButton = RaisedButton(
      ...
      disabledElevation: map.containsKey('disabledElevation')
          ? double.tryParse(map['disabledElevation'].toString())
          : 0.0,
      disabledTextColor: map.containsKey('disabledTextColor')
          ? parseHexColor(map['disabledTextColor'])
          : null,
      elevation:
          map.containsKey('elevation') ? double.tryParse(map['elevation'].toString()) : 0.0,
...
class ElevatedButtonParser extends WidgetParser {
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    return ElevatedButton(
      ...
      // style: // Backup ini style original
      // ButtonStyle(
      ...
      style: ElevatedButton.styleFrom(
        primary: map.containsKey("primary") ? parseHexColor(map["primary"]) : null,
        onPrimary: map.containsKey("onPrimary") ? parseHexColor(map["onPrimary"]) : null,
        onSurface: map.containsKey("onSurface") ? parseHexColor(map["onSurface"]) : null,
        shadowColor: map.containsKey("onSurface") ? parseHexColor(map["onSurface"]) : null,
  ...
  Widget parse(Map<String, dynamic> map, BuildContext buildContext,
    ...
    return TextButton(
      ...
      style: TextButton.styleFrom(
        shape: map.containsKey("borderRadius") ? RoundedRectangleBorder(
          borderRadius: parseBorderRadius(map["borderRadius"])
        ) : null,
        tapTargetSize: map.containsKey("tapTargetSize") ? parseTapTargetSize(map["tapTargetSize"]) : null,
